...
The Notion hub is **four databases**: **Knowledge** (the "why" + research), **Work** (Feature ▸ Task
...
|---|---|---|
| `/sdd:research "<topic>"` | Research | deep, source-grounded findings → a cited Research page (Knowledge DB) |
| `/sdd:specify "<idea>"` | 1 Specify | fills the feature template → a Shaped Work Feature row (EARS ACs) |
