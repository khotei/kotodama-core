...
|---|---|---|---|
| **Knowledge** | `/sdd:research` creates a Research doc (the "why" + onboarding wiki) | https://app.notion.com/p/4e67e142a0684e06b03f44113d6cbe92 | `collection://2424ef5d-6c97-4f86-8012-7fcd82a2202b` |
| **Work** | `/sdd:specify` creates the Feature row; `/sdd:tasks` adds Task **sub-items**; plan/verify update it | https://app.notion.com/p/3fc3612fbd014451997db03b70da94fe | `collection://25a23da3-1d76-497b-8340-9e9567cc23b7` |
