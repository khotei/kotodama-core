...
export function enrichEtymologyPrompt(
  language: Language,
  word: string,
...
export function enrichTiersPrompt(
  language: Language,
  word: string,
  grounding?: WordGrounding,
): string {
...
export function enrichVisualsPrompt(
  language: Language,
  word: string,
  grounding?: WordGrounding,
): string {
...
export function enrichAuthorsPrompt(
  language: Language,
  word: string,
  grounding?: WordGrounding,
): string {
...
export function finalReviewPrompt(
  language: Language,
  word: string,
  grounding?: WordGrounding,
): string {
...
export function authorPortraitPrompt(author: string): string {
  return `Portrait of ${author}.`
}
